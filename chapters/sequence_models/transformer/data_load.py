...
source_train = 'chapters/sequence_models/transformer/data/cn.txt'
target_train = 'chapters/sequence_models/transformer/data/en.txt'
...
def load_vocab(language):
    ...
    vocab = [
        ...
        for line in codecs.open(
            'chapters/sequence_models/transformer/data/{}.txt.vocab.tsv'.format(
                language
            ),
            'r',
            'utf-8',
...
def download_data():
    data_dir = 'chapters/sequence_models/transformer/data'
    urls = [
        (
