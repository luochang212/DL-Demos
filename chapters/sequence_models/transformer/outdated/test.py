...
# from chapters.sequence_models.transformer.dataset import MAX_SEQ_LEN, tensor_to_sentence
# from chapters.sequence_models.transformer.model import Transformer
# from chapters.sequence_models.transformer.outdated.preprocess_data import (EOS_ID, PAD_ID,
#                                                           SOS_ID,
#                                                           get_dataloader,
#                                                           load_sentences,
#                                                           load_vocab)
...
# def main():
#     model_path = 'chapters/sequence_models/transformer/model_latest.pth'
