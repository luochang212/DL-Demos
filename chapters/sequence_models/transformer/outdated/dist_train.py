...
# from chapters.sequence_models.transformer.preprocess_data import (PAD_ID, get_dataloader,
...
#     # Optional: load model
#     ckpt_path = 'chapters/sequence_models/transformer/model_latest.pth'
#     optim_path = 'chapters/sequence_models/transformer/optimizer_latest.pth'
...
#         if device_id == 0:
#             latest_model = 'chapters/sequence_models/transformer/model_latest.pth'
#             latest_optimizer = 'chapters/sequence_models/transformer/optimizer_latest.pth'
#             model_file = f'chapters/sequence_models/transformer/model_{epoch}.pth'
#             optim_file = f'chapters/sequence_models/transformer/optimizer_{epoch}.pth'
...
# # nohup bash chapters/sequence_models/transformer/dist_train.sh &
