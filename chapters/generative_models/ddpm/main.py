...
def train(ddpm: DDPM, net, device='cuda', ckpt_path='work_dirs/ddpm/model.pth'):
...
if __name__ == '__main__':
    ...
    model_path = 'work_dirs/ddpm/model_unet_res.pth'
    ...
    sample_imgs(ddpm, net, 'work_dirs/ddpm/diffusion.jpg', device=device)
