...
from chapters.generative_models.ddpm.main import sample_imgs
...
def test_ddpm_forward_backward_and_output_path():
    ...
    output_path = Path('work_dirs/ddpm/test_sample.jpg')
