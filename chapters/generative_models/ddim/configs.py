mnist_cfg = {
    'dataset_type': 'MNIST',
    'img_shape': [1, 28, 28],
    'model_path': 'work_dirs/ddim/mnist.pth',
    'batch_size': 512,
    'n_epochs': 50,
...
celebahq_cfg1 = {
    ...
    'img_shape': [3, 128, 128],
    'model_path': 'work_dirs/ddim/celebahq1.pth',
    'batch_size': 64,
    'n_epochs': 1000,
...
celebahq_cfg2 = {
    'dataset_type': 'CelebAHQ',
    'img_shape': [3, 64, 64],
    'model_path': 'work_dirs/ddim/celebahq2.pth',
    'batch_size': 128,
    'n_epochs': 2500,
    'scheduler_cfg': {
        'lr': 5e-4,
...
celebahq_cfg3 = {
    'dataset_type': 'CelebAHQ',
    'img_shape': [3, 128, 128],
    'model_path': 'work_dirs/ddim/celebahq3.pth',
    'batch_size': 32,
    'n_epochs': 1500,
    'scheduler_cfg': {
        'lr': 2e-4,
...
celebahq_cfg4 = {
    'dataset_type': 'CelebAHQ',
    'img_shape': [3, 256, 256],
    'model_path': 'work_dirs/ddim/celebahq4.pth',
    'batch_size': 8,
    'n_epochs': 1000,
    'scheduler_cfg': {
        'lr': 2e-5,
...
configs = [mnist_cfg, celebahq_cfg1, celebahq_cfg2, celebahq_cfg3, celebahq_cfg4]
