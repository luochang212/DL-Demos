...
if __name__ == '__main__':
    ...
    sample_imgs(
        ddpm,
        net,
        'work_dirs/ddim/diffusion_ddpm_sigma_hat',
        img_shape,
        device=device,
        to_bgr=to_bgr,
    )
    ...
    sample_imgs(
        ddim,
        net,
        'work_dirs/ddim/diffusion_ddpm_eta_0',
        img_shape,
        device=device,
        to_bgr=to_bgr,
        ddim_step=1000,
...
# torchrun --nproc_per_node=8 chapters/generative_models/ddim/dist_sample.py -c 2 \
#   > work_dirs/ddim/tmp.txt
