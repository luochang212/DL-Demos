...
def download_dataset():
    ...
    img.save('work_dirs/ddim/tmp.jpg')
...
class MNISTImageDataset(Dataset):
    def __init__(self, root='data/mnist', download=True):
        super().__init__()
        self.mnist = torchvision.datasets.MNIST(root=root, download=download)
...
def get_dataloader(
    ...
    if type == 'CelebAHQ':
        ...
        dataset = MNISTImageDataset(root=data_root)
    if dist_train:
