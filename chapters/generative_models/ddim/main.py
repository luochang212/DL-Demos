...
def train(
    ...
    n_epochs=50,
    device='cuda',
    ckpt_path='work_dirs/ddpm/model.pth',
):
    ensure_parent_dir(ckpt_path)
    print('batch size:', batch_size)
    n_steps = ddpm.n_steps
    dataloader = get_dataloader(dataset_type, batch_size, resolution=resolution)
    net = net.to(device)
    loss_fn = nn.MSELoss()
...
if __name__ == '__main__':
    ...
    sample_imgs(
        ddpm,
        net,
        'work_dirs/ddim/diffusion_ddpm_sigma_hat.jpg',
        img_shape,
        device=device,
        to_bgr=to_bgr,
    )
    sample_imgs(
        ddim,
        net,
        'work_dirs/ddim/diffusion_ddpm_eta_0.jpg',
        img_shape,
        device=device,
        to_bgr=to_bgr,
        ddim_step=1000,
    ...
    sample_imgs(
        ddim,
        net,
        'work_dirs/ddim/diffusion_ddim_sigma_hat.jpg',
        img_shape,
        device=device,
        simple_var=True,
        to_bgr=to_bgr,
    ...
    sample_imgs(
        ddim,
        net,
        'work_dirs/ddim/diffusion_ddim_eta_1.jpg',
        img_shape,
        device=device,
        simple_var=False,
        eta=1,
    ...
    sample_imgs(
        ddim,
        net,
        'work_dirs/ddim/diffusion_ddim_eta_0.jpg',
        img_shape,
        device=device,
        simple_var=False,
        eta=0,
