...
from chapters.generative_models.vqvae.main import reconstruct, sample_imgs
...
def test_vqvae_forward_backward_reconstruct_and_sample_paths():
    ...
    assert Path('work_dirs/vqvae/reconstruct_MNIST.jpg').exists()
    assert Path('work_dirs/vqvae/sample_MNIST.jpg').exists()
